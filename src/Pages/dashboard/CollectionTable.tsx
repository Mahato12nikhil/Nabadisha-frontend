...
const CollectionAgGridTable: React.FC<CollectionAgGridTableProps> = ({
  ...
  // Define column definitions with custom header styling
  ...
  return (
    <div className="p-4 w-full">
      <div className="ag-theme-quartz w-full h-[500px] rounded-lg border">
        <AgGridReact<ICollection>
          ...
          defaultColDef={{
            ...
            filter: true,
            resizable: true,
            headerClass: "text-center bg-blue-100 text-black-800 font-semibold", // Center headers
            cellStyle: { textAlign: "center" }, // Center cell text
          }}
          pagination={true}
